...
const links = [
  { to: "/my-portfolio/", label: "home", end: true },
  { to: "/my-portfolio/services", label: "services" },
  { to: "/my-portfolio/about", label: "about" },
  { to: "/my-portfolio/certifications", label: "certs" },
  { to: "/my-portfolio/projects", label: "projects" },
  { to: "/my-portfolio/contact", label: "contact" },
]
    ...
    <>
      <style>{`
        ...
        .nav-link:hover::before {
          border-color: ${NEON}33;
        }

        .active-link {
          color: ${NEON} !important;
          background: ${NEON}11 !important;
          text-shadow: 0 0 8px ${NEON}88;
        }
        .active-link::before {
          border-color: ${NEON}44 !important;
          box-shadow: inset 0 0 8px ${NEON}11;
        }
        .active-dot {
          position: absolute;
          bottom: 3px; left: 50%;
        ...
        .nav-cta {
          ...
          text-decoration: none;
          transition: all 0.25s;
          box-shadow: 0 0 14px ${NEON}44;
          font-family: 'JetBrains Mono', monospace;
        }
        .nav-cta:hover {
          box-shadow: 0 0 24px ${NEON}88;
        ...
        .mobile-divider {
          height: 1px;
          background: linear-gradient(to right, ${NEON}22, transparent);
          margin: 1rem 0;
        }
        .mobile-cta {
          display: block;
      ...
      <nav className={`navbar ${scrolled ? "scrolled" : "top"}`}>
        ...
        {/* Desktop CTA */}
        <a href="/my-portfolio/contact" className="nav-cta desktop-nav">
          Hire me →
        </a>
      ...
      <div className={`mobile-drawer ${open ? "open" : ""}`}>
        ...
        <a href="/my-portfolio/contact" className="mobile-cta" onClick={() => setOpen(false)}>
          Hire me →
        </a>
      </div>
    </>
